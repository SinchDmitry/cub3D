...
/*   Updated: 2022/03/22 21:40:16 by utygett          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_images(t_data_mlx *data)
{
	...
	data->image.compas = mlx_xpm_file_to_image(data->mlx, "./textures/N.xpm", \
			&img_h, &img_w);
	//init door
	data->door.img = mlx_xpm_file_to_image(data->mlx, "./textures/door.xpm", \
		&data->door.img_h, &data->door.img_w);
	data->door.addr = mlx_get_data_addr(data->door.img, &data->door.bits_per_pixel, \
