...
/*   Updated: 2022/02/20 15:28:34 by utygett          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void pixel_put_map_move(int x, int y, t_data_mlx *data, int color)
{
	...
	x = (x1 - h) * cos(data->map->player.a - ROTATE_MOV) + (y1 - w) * sin(data->map->player.a - ROTATE_MOV);
	y = (x1 - h) * sin(data->map->player.a - ROTATE_MOV) - (y1 - w) * cos(data->map->player.a - ROTATE_MOV);
